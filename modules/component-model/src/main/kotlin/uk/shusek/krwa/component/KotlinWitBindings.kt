...
class KotlinWitBindings private constructor(builder: Builder) {
    ...
    private fun rootGuestAsyncExport(function: Function): GuestAsyncExport {
        val functionName = wasmFunctionName(function)
    ...
    private fun wasmFunctionName(function: Function): String =
        if (function.isAsync) "[async]${function.name()}" else function.name()
