...
This module is used to run JMH performance tests on Kotlin Runtime Web Assembly and make it easy to compare results.
...
```bash
docker run --rm -it -p 3000:3000 docker.io/andreatp/krwa-show-jmh ci <link-to-baseline-results> <link-to-current-results>
```
