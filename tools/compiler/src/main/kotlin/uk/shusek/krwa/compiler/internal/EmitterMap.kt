...
internal class EmitterMap private constructor() {
    companion object {
        @JvmField
        val EMITTERS: Map<CompilerOpCode, Emitters.BytecodeEmitter> =
            Emitters.builder()
                // ====== Misc ======
                ...
                .intrinsic(CompilerOpCode.ATOMIC_INT_LOAD_SHORT, Emitters::ATOMIC_INT_READ_SHORT)
                .intrinsic(CompilerOpCode.ATOMIC_LONG_LOAD, Emitters::ATOMIC_LONG_READ)
                .intrinsic(CompilerOpCode.ATOMIC_LONG_LOAD_BYTE, Emitters::ATOMIC_LONG_READ_BYTE)
                .intrinsic(CompilerOpCode.ATOMIC_LONG_LOAD_SHORT, Emitters::ATOMIC_LONG_READ_SHORT)
                ...
                .intrinsic(CompilerOpCode.ATOMIC_INT_STORE_BYTE, Emitters::ATOMIC_INT_STORE_BYTE)
                .intrinsic(CompilerOpCode.ATOMIC_INT_STORE_SHORT, Emitters::ATOMIC_INT_STORE_SHORT)
                .intrinsic(CompilerOpCode.ATOMIC_LONG_STORE, Emitters::ATOMIC_LONG_STORE)
                .intrinsic(CompilerOpCode.ATOMIC_LONG_STORE_BYTE, Emitters::ATOMIC_LONG_STORE_BYTE)
                .intrinsic(
                    CompilerOpCode.ATOMIC_LONG_STORE_SHORT,
                    Emitters::ATOMIC_LONG_STORE_SHORT,
                )
                .intrinsic(CompilerOpCode.ATOMIC_LONG_STORE_INT, Emitters::ATOMIC_LONG_STORE_INT)
                ...
                .intrinsic(CompilerOpCode.ATOMIC_INT_RMW_CMPXCHG, Emitters::ATOMIC_INT_RMW_CMPXCHG)
                .intrinsic(CompilerOpCode.ATOMIC_INT_RMW8_ADD_U, Emitters::ATOMIC_INT_RMW8_ADD_U)
                .intrinsic(CompilerOpCode.ATOMIC_INT_RMW8_SUB_U, Emitters::ATOMIC_INT_RMW8_SUB_U)
                .intrinsic(CompilerOpCode.ATOMIC_INT_RMW8_AND_U, Emitters::ATOMIC_INT_RMW8_AND_U)
                .intrinsic(CompilerOpCode.ATOMIC_INT_RMW8_OR_U, Emitters::ATOMIC_INT_RMW8_OR_U)
                .intrinsic(CompilerOpCode.ATOMIC_INT_RMW8_XOR_U, Emitters::ATOMIC_INT_RMW8_XOR_U)
                .intrinsic(CompilerOpCode.ATOMIC_INT_RMW8_XCHG_U, Emitters::ATOMIC_INT_RMW8_XCHG_U)
                .intrinsic(
                    CompilerOpCode.ATOMIC_INT_RMW8_CMPXCHG_U,
                    Emitters::ATOMIC_INT_RMW8_CMPXCHG_U,
                )
                .intrinsic(CompilerOpCode.ATOMIC_INT_RMW16_ADD_U, Emitters::ATOMIC_INT_RMW16_ADD_U)
                .intrinsic(CompilerOpCode.ATOMIC_INT_RMW16_SUB_U, Emitters::ATOMIC_INT_RMW16_SUB_U)
                .intrinsic(CompilerOpCode.ATOMIC_INT_RMW16_AND_U, Emitters::ATOMIC_INT_RMW16_AND_U)
                .intrinsic(CompilerOpCode.ATOMIC_INT_RMW16_OR_U, Emitters::ATOMIC_INT_RMW16_OR_U)
                .intrinsic(CompilerOpCode.ATOMIC_INT_RMW16_XOR_U, Emitters::ATOMIC_INT_RMW16_XOR_U)
                .intrinsic(
                ...
                .intrinsic(CompilerOpCode.ATOMIC_LONG_RMW8_ADD_U, Emitters::ATOMIC_LONG_RMW8_ADD_U)
                .intrinsic(CompilerOpCode.ATOMIC_LONG_RMW8_SUB_U, Emitters::ATOMIC_LONG_RMW8_SUB_U)
                .intrinsic(CompilerOpCode.ATOMIC_LONG_RMW8_AND_U, Emitters::ATOMIC_LONG_RMW8_AND_U)
                .intrinsic(CompilerOpCode.ATOMIC_LONG_RMW8_OR_U, Emitters::ATOMIC_LONG_RMW8_OR_U)
                .intrinsic(CompilerOpCode.ATOMIC_LONG_RMW8_XOR_U, Emitters::ATOMIC_LONG_RMW8_XOR_U)
                .intrinsic(
                ...
                .intrinsic(CompilerOpCode.ATOMIC_LONG_RMW16_OR_U, Emitters::ATOMIC_LONG_RMW16_OR_U)
                .intrinsic(
                ...
                .intrinsic(CompilerOpCode.ATOMIC_LONG_RMW32_OR_U, Emitters::ATOMIC_LONG_RMW32_OR_U)
                .intrinsic(
                ...
                .shared(CompilerOpCode.I32_CLZ, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.I32_CONST, Emitters::I32_CONST)
                .shared(CompilerOpCode.I32_CTZ, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_DIV_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_DIV_U, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_EQ, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_EQZ, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_EXTEND_8_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_EXTEND_16_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_GE_S, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.I32_GE_U, Emitters::I32_GE_U)
                .shared(CompilerOpCode.I32_GT_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_GT_U, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_LE_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_LE_U, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_LT_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_LT_U, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.I32_MUL, Emitters::I32_MUL)
                .shared(CompilerOpCode.I32_NE, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.I32_OR, Emitters::I32_OR)
                .shared(CompilerOpCode.I32_POPCNT, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_REINTERPRET_F32, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_REM_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_REM_U, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_ROTL, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_ROTR, OpcodeImpl::class.java)
                ...
                .shared(CompilerOpCode.I32_TRUNC_F32_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_TRUNC_F32_U, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_TRUNC_F64_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_TRUNC_F64_U, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_TRUNC_SAT_F32_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_TRUNC_SAT_F32_U, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_TRUNC_SAT_F64_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I32_TRUNC_SAT_F64_U, OpcodeImpl::class.java)
                ...
                .shared(CompilerOpCode.I64_CLZ, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.I64_CONST, Emitters::I64_CONST)
                .shared(CompilerOpCode.I64_CTZ, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_DIV_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_DIV_U, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_EQ, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_EQZ, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_EXTEND_8_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_EXTEND_16_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_EXTEND_32_S, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.I64_EXTEND_I32_S, Emitters::I64_EXTEND_I32_S)
                .shared(CompilerOpCode.I64_EXTEND_I32_U, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_GE_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_GE_U, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_GT_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_GT_U, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_LE_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_LE_U, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_LT_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_LT_U, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.I64_MUL, Emitters::I64_MUL)
                .shared(CompilerOpCode.I64_NE, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.I64_OR, Emitters::I64_OR)
                .shared(CompilerOpCode.I64_POPCNT, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_REM_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_REM_U, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_ROTL, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_ROTR, OpcodeImpl::class.java)
                ...
                .shared(CompilerOpCode.I64_REINTERPRET_F64, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_TRUNC_F32_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_TRUNC_F32_U, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_TRUNC_F64_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_TRUNC_F64_U, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_TRUNC_SAT_F32_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_TRUNC_SAT_F32_U, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_TRUNC_SAT_F64_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.I64_TRUNC_SAT_F64_U, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.I64_XOR, Emitters::I64_XOR)

                // ====== F32 ======
                .shared(CompilerOpCode.F32_ABS, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.F32_ADD, Emitters::F32_ADD)
                .shared(CompilerOpCode.F32_CEIL, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.F32_CONST, Emitters::F32_CONST)
                .shared(CompilerOpCode.F32_CONVERT_I32_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F32_CONVERT_I32_U, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F32_CONVERT_I64_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F32_CONVERT_I64_U, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F32_COPYSIGN, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.F32_DEMOTE_F64, Emitters::F32_DEMOTE_F64)
                .intrinsic(CompilerOpCode.F32_DIV, Emitters::F32_DIV)
                .shared(CompilerOpCode.F32_EQ, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F32_FLOOR, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F32_GE, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F32_GT, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F32_LE, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F32_LT, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F32_MAX, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F32_MIN, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.F32_MUL, Emitters::F32_MUL)
                .shared(CompilerOpCode.F32_NE, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.F32_NEG, Emitters::F32_NEG)
                .shared(CompilerOpCode.F32_NEAREST, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F32_REINTERPRET_I32, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F32_SQRT, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.F32_SUB, Emitters::F32_SUB)
                .shared(CompilerOpCode.F32_TRUNC, OpcodeImpl::class.java)

                // ====== F64 ======
                .shared(CompilerOpCode.F64_ABS, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.F64_ADD, Emitters::F64_ADD)
                .shared(CompilerOpCode.F64_CEIL, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.F64_CONST, Emitters::F64_CONST)
                .shared(CompilerOpCode.F64_CONVERT_I32_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F64_CONVERT_I32_U, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F64_CONVERT_I64_S, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F64_CONVERT_I64_U, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F64_COPYSIGN, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.F64_DIV, Emitters::F64_DIV)
                .shared(CompilerOpCode.F64_EQ, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F64_FLOOR, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F64_GE, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F64_GT, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F64_LE, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F64_LT, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F64_MAX, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F64_MIN, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.F64_MUL, Emitters::F64_MUL)
                .shared(CompilerOpCode.F64_NE, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.F64_NEG, Emitters::F64_NEG)
                .shared(CompilerOpCode.F64_NEAREST, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.F64_PROMOTE_F32, Emitters::F64_PROMOTE_F32)
                .shared(CompilerOpCode.F64_REINTERPRET_I64, OpcodeImpl::class.java)
                .shared(CompilerOpCode.F64_SQRT, OpcodeImpl::class.java)
                .intrinsic(CompilerOpCode.F64_SUB, Emitters::F64_SUB)
                .shared(CompilerOpCode.F64_TRUNC, OpcodeImpl::class.java)
